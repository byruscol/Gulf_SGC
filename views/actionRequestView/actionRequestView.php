<div class="row-fluid">
    <div class="span11">
        <div class="jqGrid">
            <div class="wrap">
                ...
                <h2><?php echo $resource->getWord("actionRequest"); ?></h2>
            </div>
            <div class="span12">
            <table id="actionRequest"></table>
            <div id="actionRequestPager"></div>
            </div>
        </div>
    </div>
    ...
    <div id="tabs" class="span11">
        <ul id="actionRequestTab" class="nav nav-tabs">
                        ...
                        <form id="uploadFiles" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="control-group">
                              <div class="controls">
                                ...
                                <input type="hidden" name="parentRelationShip" value="actionRequest"/>
                              </div>
                            </div>
                            <br/>
                            <!-- Text input-->
...
<script>
    jQuery(function () {
      ...
      var tab = jQuery('#actionRequestTab li:eq(0) a').attr("href");
